    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold"><?=$this->lang->line('about'); ?></span> - <?=$this->lang->line('edit_about'); ?></h4>
            </div>
        </div>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title"><?=$this->lang->line('edit_about'); ?></h5>
			...
			<form action="<?php echo base_url('admin/about/save'); ?>" enctype="multipart/form-data" method="post">
				<ul class="nav nav-tabs">
					...
					<li><a data-toggle="tab" href="#menu1">Introduction</a></li>
				</ul>
				<div class="tab-content">
					<div id="home" class="tab-pane fade in active">
					<textarea name="content_vn"><?php echo $about_vn; ?></textarea>
					</div>
					<div id="menu1" class="tab-pane fade">
					<textarea name="content_us"><?php echo $about_us; ?></textarea>
					</div>
				</div>
