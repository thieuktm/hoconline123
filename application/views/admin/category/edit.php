...
<div class="row">
    <div class="col-sm-12">
        <form action="<?php echo base_url('admin/cate/edit/'.$result['id'].'');?>" id="frm_news_New" class="form-horizontal"   method="post"  enctype="multipart/form-data">
            <div class="form-group <?php if(form_error('title') != NULL){echo 'has-error';}else if(!empty($error_news)){echo 'has-error';}?>">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="" name="title" value = "<?php if($result['title'] != NULL){ echo $result['title'];}else{echo set_value('title');}?>">
            ...
            <div class="form-group <?php if(form_error('keyword') != NULL){echo 'has-error';}else if(!empty($error_mail)){echo 'has-error';}?>">
                ...
                <div class="col-sm-10">
                    <input name="keyword" class="form-control" placeholder="" value="<?php if($result['keyword'] != NULL){ echo $result['title'];}else{echo set_value('keyword');}?>" id="keyword" type="text">
            ...
            <div class="form-group <?php if(form_error('description') != NULL){echo 'has-error';}?>">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="description" id="description" cols="30" rows="5" placeholder="Mô t? s?n ph?m"><?php if($result['description'] != NULL){ echo $result['description'];}else{echo set_value('description');}?></textarea>
                    ...
                    <select name="category" id="" class="form-control">
                        ...
                        if(is_array($cate_parent) && $cate_parent != NULL):
                            foreach($cate_parent as $value):
                                ?>
                                <option value="<?php echo $value['id']?>" <?php if($value['id'] == $result['parent']){ echo "selected";}?>><?php echo $value['title']?></option>
            ...
            <div class="form-group <?php if(form_error('avarta') != NULL){echo 'has-error';}?>">
                ...
                <div class="col-sm-10">
                    <input name="avarta" class="form-control" placeholder="icon fontawesome ho?c icon bootstraps" value='<?php if($result['avarta'] != NULL){ echo $result['avarta'];}else{echo set_value('avarta');}?>' id="keyword" type="text">
                    <?php echo $result['avarta'];?>
            ...
            <div class="form-group <?php if(form_error('Order') != NULL){echo 'has-error';}?>">
                ...
                <div class="col-sm-10">
                    <input name="Order" class="form-control" placeholder="bé trư?c l?n sau" value="<?php if($result['Order'] != NULL){ echo $result['Order'];}else{echo set_value('Order');}?>" id="" type="number">
...
<script>
    ...
    $("#fileuploader").uploadFile({
        url:"<?php SITE_URL?>/admin/news/upload",
        fileName:"file",
        multiple:false,
        showAbort: false,
        showDone: false,
        ...
        onSuccess: function (files, response, xhr, pd) {
            ...
            var img = '<?php echo SITE_URL."upload/news/";?>'+response
