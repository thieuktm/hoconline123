...
<div id="content" class="span10">
	...
	<div class="row-fluid">
		...
		<div class="span3 statbox purple" onTablet="span6" onDesktop="span3">
			...
			<div class="number">854<i class="icon-arrow-up"></i>
			</div>
		...
		<div class="span3 statbox green" onTablet="span6" onDesktop="span3">
			...
			<div class="number">123<i class="icon-arrow-up"></i>
			</div>
		...
		<div class="span3 statbox blue noMargin" onTablet="span6" onDesktop="span3">
			<div class="boxchart">5,6,7,2,0,-4,-2,4,8,2,3,3,2</div>
			<div class="number">982<i class="icon-arrow-up"></i>
			</div>
		...
		<div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
			...
			<div class="number">678<i class="icon-arrow-down"></i>
			</div>
			<div class="title">visits</div>
			<div class="footer">
				<a href="#"> read full report</a>
		...
		<div class="widget span3 red" onTablet="span6" onDesktop="span3">
			...
			<div class="content">
				...
				<div class="browserStat big">
					<img src="<?=base_url('assets/') ?>img/browser-chrome-big.png" alt="Chrome">
					<span>34%</span>
				</div>
				<div class="browserStat big">
					<img src="<?=base_url('assets/') ?>img/browser-firefox-big.png" alt="Firefox">
					<span>34%</span>
				</div>
				<div class="browserStat">
					<img src="<?=base_url('assets/') ?>img/browser-ie.png" alt="Internet Explorer">
					<span>34%</span>
				</div>
				<div class="browserStat">
					<img src="<?=base_url('assets/') ?>img/browser-safari.png" alt="Safari">
					<span>34%</span>
				</div>
				<div class="browserStat">
					<img src="<?=base_url('assets/') ?>img/browser-opera.png" alt="Opera">
					<span>34%</span>
				</div>
		...
		<div class="box black span4" onTablet="span6" onDesktop="span4">
			...
			<div class="box-content">
				<ul class="dashboard-list metro">
					<li class="green">
						<a href="#">
						<img class="avatar" alt="Dennis Ji" src="<?=base_url('assets/') ?>img/avatar.jpg">
					</a>
		...
		<div class="box black span4 noMargin" onTablet="span12" onDesktop="span4">
			...
			<div class="box-content">
				<div class="todo metro">
					<ul class="todo-list">
						<li class="red">
							<a class="action icon-check-empty" href="#"></a> Windows Phone 8 App
							<strong>today</strong>
						</li>
						<li class="red">
							<a class="action icon-check-empty" href="#"></a> New frontend layout
							<strong>today</strong>
						</li>
						<li class="yellow">
							<a class="action icon-check-empty" href="#"></a> Hire developers
