...
-- Thời gian đã tạo: Th10 07, 2017 lúc 12:43 AM
...
--
CREATE DATABASE IF NOT EXISTS `hoconline` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `hoconline`;
...
INSERT INTO `hoc_vien` (`MaHV`, `ho_ten`, `email`, `pass`, `phone`, `dia_chi`, `ngay_sinh`, `giới tính`, `ngay_dk`, `active`) VALUES
